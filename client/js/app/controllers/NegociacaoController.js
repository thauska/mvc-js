...
System.register(['../models/ListaNegociacoes', '../models/Mensagem', '../models/Negociacao', '../views/NegociacoesView', '../views/MensagemView', '../services/NegociacaoServices', '../helpers/DateConverter', '../helpers/Bind'], function (_export, _context) {
  "use strict";

  var ListaNegociacoes, Mensagem, Negociacao, NegociacoesView, MensagemView, NegociacaoServices, DateConverter, Bind, _createClass, NegociacaoController, negociacaoController;
      ...
      NegociacaoController = function () {
        ...
        _createClass(NegociacaoController, [{
          ...
          value: function _criaNegociacao() {
            return new Negociacao(DateConverter.textToDate(this._inputData.value), parseInt(this._inputQntd.value), parseFloat(this._inputValor.value));
          }
        }, {
